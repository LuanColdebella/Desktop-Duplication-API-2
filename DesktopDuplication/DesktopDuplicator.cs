...
namespace DesktopDuplication
{
    ...
    public class DesktopDuplicator
    {
        ...
        public void SaveTextureToFile(SharpDX.Direct3D11.Texture2D texture, string name )
        {
            ...
            try
            {
                // Cria um bitmap com as dimensões da textura  
                using (var bitmap = new Bitmap(texture.Description.Width, texture.Description.Height, System.Drawing.Imaging.PixelFormat.Format32bppArgb))
                {
                    ...
                    // Copia os dados da textura para o bitmap  
                    var sourcePtr = mapped.DataPointer;
                    var destPtr = bitmapData.Scan0;
                    for (int y = 0; y < texture.Description.Height; y++)
                    {
                        SharpDX.Utilities.CopyMemory(destPtr, sourcePtr, texture.Description.Width * 4);
                        sourcePtr = System.IntPtr.Add(sourcePtr, mapped.RowPitch);
                        destPtr = System.IntPtr.Add(destPtr, bitmapData.Stride);
                    }
        ...
        /// </summary>
        public DesktopFrame GetLatestFrame(int qtde)
        {
            ...
            SaveTextureToFile(desktopImageTexture, $"frame_{qtde}.png");
